    ...
    public class DanhMucController : ControllerBase
    {
        ...
        public async Task<ActionResult<Danhmuc>> AddDanhmuc(Danhmuc danhmuc)
        {
            try
            {
                ...
                var danhmucnew = await _repository.AddDanhmucs(danhmuc);
        ...
        [HttpPut("{id}")]
        public async Task<IActionResult> UpdateDanhmuc(int id, [FromBody] Danhmuc danhmuc)
        {
            if (danhmuc == null || id != danhmuc.MaDanhmuc)
            {
            ...
            try
            {
                ...
                var updatedDanhmuc = await _repository.UpdateDanhmuc(id, danhmuc);
